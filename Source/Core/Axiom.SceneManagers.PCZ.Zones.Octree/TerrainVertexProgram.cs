...
//     <id value="$Id: TerrainVertexProgram.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace OctreeZone
{
	...
	{
		private const string mNoFogArbvp1 =
		...
		private const string mShadowReceiverArbvp1 =
		...
		private const string mLinearFogArbvp1 =
		...
		private const string mExpFogArbvp1 =
		...
		private const string mExp2FogArbvp1 =
		...
		private const string mNoFogVs_1_1 =
			"vs_1_1\n" + "def c5, 1, 1, 1, 1\n" + "//var float4x4 worldViewProj :  : c[0], 4 : 8 : 1\n" +
			"//var float morphFactor :  : c[4] : 9 : 1\n" + "dcl_blendweight v1\n" + "dcl_texcoord1 v8\n" + "dcl_texcoord0 v7\n" +
		...
		private const string mLinearFogVs_1_1 =
			"vs_1_1\n" + "def c5, 1, 1, 1, 1\n" + "//var float4x4 worldViewProj :  : c[0], 4 : 9 : 1\n" +
			"//var float morphFactor :  : c[4] : 10 : 1\n" + "dcl_blendweight v1\n" + "dcl_texcoord1 v8\n" + "dcl_texcoord0 v7\n" +
		...
		private const string mShadowReceiverVs_1_1 =
			"vs_1_1\n" + "def c13, 1, 1, 1, 1\n" + "dcl_blendweight v1\n" + "dcl_texcoord1 v8\n" + "dcl_texcoord0 v7\n" +
		...
		private const string mExpFogVs_1_1 =
		...
		private const string mExp2FogVs_1_1 =
