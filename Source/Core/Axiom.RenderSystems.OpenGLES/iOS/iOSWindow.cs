...
//     <id value="$Id: iOSWindow.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.RenderSystems.OpenGLES.iOS
{
	class iOSWindow : RenderWindow
	{
		...
		private GLESContext _glContext;
		private GLESSupport _glSupport;
		private EAGLContext _context;
		private NativeWindowType _window;
		private NativeDisplayType _nativeDisplay;
		//private EGLDisplay _eglDisplay;
		//private MonoTouch.OpenGLES.EAGLConfig _eglConfig;
		...
		/// <returns></returns>
		/*
		protected object CreateSurfaceFromWindow( EGLDisplay display, NativeWindowType win )
		{
