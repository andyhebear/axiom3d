...
//     <id value="$Id: GLESFBOManager.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.RenderSystems.OpenGLES
{
	...
	/// </summary>
	public class GLESFBOManager : GLESRTTManager
	{
		/// <summary>
		...
		/// </summary>
		public static All[] StencilFormats = new All[]
		{
			//no stencil
			All.NoneOes,
		...
		/// 
		/// </summary>
		public static int[] StencilBits = new int[]
		{
			0,
			8
		};
		...
		/// 
		/// </summary>
		public static All[] DepthFormats = new All[]
		{
			All.NoneOes,
		...
		/// 
		/// </summary>
		public static int[] DepthBits = new int[]
		{
			0,
			16,
			24,
