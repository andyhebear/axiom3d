...
//     <id value="$Id: GLESCopyingRTTManager.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.RenderSystems.OpenGLES
{
	internal class GLESCopyingRTTManager : GLESRTTManager
	{
		...
		public override RenderTexture CreateRenderTexture( string name, GLESSurfaceDescription target, bool writeGama, int fsaa )
		{
			return new GLESCopyingRenderTexture( this, name, target, writeGama, fsaa );
		}
