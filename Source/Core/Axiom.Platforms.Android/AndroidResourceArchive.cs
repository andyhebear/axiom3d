...
//     <id value="$Id: AndroidResourceArchive.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
{
	public class AndroidResourceArchive : Archive
	{
		private string _type;

		public AndroidResourceArchive( string name, string type )
			: base( name, type )
		{
	...
	public class AndroidArchiveFactory : ArchiveFactory
	{
		...
		private const string _type = "AndroidResource";
		...
		{
			return new AndroidResourceArchive( name, _type );
		}
